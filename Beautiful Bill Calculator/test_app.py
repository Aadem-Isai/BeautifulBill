...
def index():
    ...
    try:
        ...
        print(f"Method: {method}, Year: {year}")  # Debug print
        ...
        if method == 'basic':
            ...
            print(f"Basic mode - Winnings: {winnings_raw}, Losses: {losses_raw}")  # Debug print
            ...
            print(f"ROI mode - Profit: {profit_raw}, ROI: {roi_raw}")  # Debug print
        ...
        print(f"Calculation successful: {result}")  # Debug print
        ...
        <head>
            ...
            <style>
                body {{ font-family: sans-serif; max-width: 600px; margin: auto; padding: 1rem; }}
                .result {{ background-color: #f0f0f0; padding: 1rem; margin-top: 1rem; }}
                .back-link {{ display: inline-block; margin-top: 1rem; padding: 0.5rem 1rem; background-color: #007bff; color: white; text-decoration: none; border-radius: 4px; }}
            </style>
        </head>
        <body>
...
if __name__ == '__main__':
    print("Starting Beautiful Bill Tax Calculator...")
